...
INSERT INTO `author` VALUES (1,'Harry','Otter','1962-03-19','Finland'),(2,'Harry','Otter','1962-03-19','Finland');
...
CREATE TABLE `book_author` (
  ...
  CONSTRAINT `author_fkey` FOREIGN KEY (`author_id`) REFERENCES `author` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `product_type` VALUES (1,'General',''),(2,'Film','film'),(3,'Book','book');
...
CREATE TABLE `products` (
  ...
  `product_type` mediumint(8) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
...
INSERT INTO `products` VALUES (2,'Yeesus','Kanye West',149.00,1000.00,1),(3,'Megalithic Melody','AWOLNATION',145.00,199.00,1),(4,'VIVA LA VIDA','AWESOME',200.00,0.00,1),(7,'Mylo Xyloto','Lovers in Japan',149.00,0.00,1),(8,'Mylo Xyloto',NULL,149.00,0.00,1),(10,'Mylo Xyloto','Epic album!!',149.00,3000.00,1),(11,'Parachutes','So good',149.00,3000.00,1),(33,'Mylo Xyloto','Coldplay, 2012',149.00,1000.00,1),(34,'Streets of Gold','3oh!3',149.00,1000.00,1),(37,'Yeesus','Kanye West',149.00,1000.00,1),(38,'Hybrid','Linkin',200.00,201.00,1),(39,'Hybrid Theory','Linkin Park',149.00,200.00,1),(40,'odalys','best mom',100.00,200.00,1);
...
INSERT INTO `users` VALUES ('isabella','rodz','isabella','rodriguez','1992-11-30','0700093719','kavallerigatan','dde','upplands','19475'),('ook@','ok','hello','ok','1992-01-02','05905425235','okorke','ofdk','stockholm','14343');
...
-- Dump completed on 2014-02-19 12:00:08
